                    ...
                    <form method="POST" action="{{ route('roles.store') }}" novalidate @submit.prevent="submitForm($event)">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input
                                    ...
                                    @input="markDirty('nombre_rol'); if(!slugTouched) { form.slug_rol = slugify(form.nombre_rol); markDirty('slug_rol'); }"
                            ...
                            <div>
                                ...
                                <x-text-input
                                    ...
                                    @input="slugTouched = true; markDirty('slug_rol')"
                        ...
                        <div class="mb-6">
                            ...
                            <x-textarea
                                ...
                                class="mt-1 block w-full">{{ old('descripcion_rol', '') }}</x-textarea>
        ...
        function rolForm(rolId = null) {
            return {
                form: {
                    ...
                    slug_rol: @js(old('slug_rol', '')),
                    descripcion_rol: @js(old('descripcion_rol', '')),
                ...
                regen() {
                    this.form.slug_rol = this.slugify(this.form.nombre_rol);
                    this.slugTouched = false;
                    this.markDirty('slug_rol');
                },
