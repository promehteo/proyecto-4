            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="w-full">
                    <form method="POST" action="{{ route('permisos.update', $permiso) }}" novalidate
                        x-data="{
                            nombre: @js(old('nombre_permiso', $permiso->nombre_permiso)),
                            slug: @js(old('slug_permiso', $permiso->slug_permiso)),
                            slugTouched: @js(old('slug_permiso') !== null && old('slug_permiso') !== $permiso->slug_permiso),
                            desc: @js(old('descripcion_permiso', $permiso->descripcion_permiso)),
