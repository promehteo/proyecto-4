                    ...
                    <form method="POST" action="{{ route('permisos.update', $permiso) }}" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nombre_permiso" name="nombre_permiso" type="text"
                                class="mt-1 block w-full" :value="old('nombre_permiso', $permiso->nombre_permiso)"
                                required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="slug_permiso" name="slug_permiso" type="text"
                                class="mt-1 block w-full font-mono text-sm" :value="old('slug_permiso', $permiso->slug_permiso)" required placeholder="ej: productos.crear" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="modulo_permiso" name="modulo_permiso" type="text"
                                class="mt-1 block w-full" :value="old('modulo_permiso', $permiso->modulo_permiso)"
                                required list="list-modulos" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="descripcion_permiso" name="descripcion_permiso" rows="3"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('descripcion_permiso', $permiso->descripcion_permiso) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status" name="status" required
                                ...
                                <option value="1" {{ old('status', $permiso->status) == 1 ? 'selected' : '' }}>Activo
                                </option>
                                <option value="2" {{ old('status', $permiso->status) == 2 ? 'selected' : '' }}>Inactivo
                                </option>
                            </select>
