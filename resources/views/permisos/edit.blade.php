            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="slug_permiso" name="slug_permiso" type="text" class="mt-1 block w-full font-mono text-sm" :value="old('slug_permiso', $permiso->slug_permiso)" required />
